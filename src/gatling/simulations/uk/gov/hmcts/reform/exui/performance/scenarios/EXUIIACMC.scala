  ...
  val shareacase =
    ...
    group("XUI_IAC_300_ShareACase") {
      exec(http("XUI_IAC_300_005_ShareACase")
        ...
        .headers(Headers.commonHeader)
        .header("accept", "application/json, text/plain, */*")
        .check(jsonPath("$..email").saveAs("user0"))
      ...
      .exec(http("XUI_IAC_300_010_ShareACaseUsers")
        ...
        .headers(Headers.commonHeader)
        .header("accept", "application/json, text/plain, */*")
        .check(jsonPath("$..email").saveAs("user1"))
        .check(jsonPath("$..firstName").saveAs("firstName1"))
        .check(jsonPath("$..lastName").saveAs("lastName1"))
        .check(jsonPath("$..idamId").saveAs("idamId1")))
    }
